...
campaign_base_dir = 'C:/Users/fabcb/git/SHARC/sharc/campaigns/imt_hotspot_eess_8090MHz'
...
interf_protection_criteria20 = -150 
interf_protection_criteria05 = -133 
...
for prop_name in plots_to_add_vline:
    for plot_type in ["cdf", "ccdf"]:
        ...
        if plt:
            plt.add_vline(
                interf_protection_criteria20, line_dash="dash",
                name="1% criteria"
            )
            plt.add_vline(
                interf_protection_criteria05, line_dash="dash",
                name="1% criteria"
            )
